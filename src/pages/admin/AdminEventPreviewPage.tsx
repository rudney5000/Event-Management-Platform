...
import {EventSidePanel} from "../../features/event-side-panel/EventSidePanel.tsx";
...
export function AdminEventPreviewPage() {
    ...
    return (
        <div className="flex items-center justify-center h-screen">
          <div className="text-center">
            <h2 className="text-2xl font-bold text-gray-700 mb-2">Événement non trouvé</h2>
            <p className="text-gray-500">L'événement que vous recherchez n'existe pas.</p>
          </div>
        </div>
    );
  }
  ...
  return (
      ...
      <div className="flex h-[calc(100vh-64px)] overflow-hidden">
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-6">
              <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-xl overflow-hidden mb-6">
                  ...
                  {!event.imageUrl && (
                      <div
                          className="relative h-64 bg-gradient-to-r from-blue-400 to-purple-500 flex items-center justify-center">
                                ...
                                m.type === "video" ? (
                                    ...
                                    <div key={i} className="bg-gray-50 rounded-lg p-2 border border-gray-200">
                                      <div className="flex items-center gap-3">
                                        ...
                                        <Image src={m.url} alt={t("preview.mediaAlt", {n: i + 1})} width={120}
                                               className="rounded"/>
                                      </div>
                                    </div>
                                )
        ...
        <div className="w-[340px] border-l border-gray-200 bg-white flex-shrink-0 overflow-hidden">
          <EventSidePanel
              eventId={id!}
