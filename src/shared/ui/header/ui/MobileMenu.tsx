          ...
          <div className="-my-6 divide-y divide-white/10">
            ...
            <div className="py-6 space-y-4">
              ...
              {user ? (
                ...
                <div className="space-y-2">
                  <Link to={localizedPath('/login')} onClick={onClose} className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-white hover:bg-white/5">
                    {t('header.logIn')}
                  </Link>
                  <Link to={localizedPath('/register')} onClick={onClose} className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold bg-indigo-600 text-white hover:bg-indigo-700 text-center">
                    {t('header.signUp')}
                  </Link>
                </div>
              )}
